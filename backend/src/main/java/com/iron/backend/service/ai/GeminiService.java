...
public class GeminiService {
    ...
    private String buildPrompt(String rawText) {
        return """
            ...
            3. **카테고리 분류 규칙 (필수)**:
               - **main_category**: 반드시 다음 중 하나를 선택하시오: [가슴, 등, 하체, 어깨, 팔, 복근, 유산소, 전신]. 
                 - 힌트: 벤치프레스->가슴, 턱걸이->등, 스쿼트->하체, 밀리터리프레스->어깨, 이두컬->팔.
                 - 절대 "OTHER"나 "기타"를 사용하지 마시오. 모르면 "전신"이라도 넣으시오.
               - **sub_category**: [바벨, 덤벨, 머신, 케이블, 맨몸, 이지바, 스미스머신] 중 택1.
